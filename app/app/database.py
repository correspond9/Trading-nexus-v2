...
app/database.py
===============
asyncpg connection pool ΓÇö single pool shared across all modules.
...
# Module-level pool ΓÇö initialised once, used everywhere
...
async def init_db() -> None:
    ...
    global _pool
    cfg = get_settings()
    log.info("Connecting to PostgreSQLΓÇª")

...
Synchronous (no I/O) ΓÇö runs before the latency delay.
"""
...
def check_rejection(
    ...
    lot_size: instrument lot size ΓÇö quantity must be a positive multiple of this.
    """
    ...
    # 4. Liquidity check ΓÇö at least some qty must exist on the required side

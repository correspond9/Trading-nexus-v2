...
==================================
Polling loop ΓÇö calls POST /optionchain every 15 seconds per active expiry.
...
With 12 active expiry slots ΓåÆ 12 calls per 15s cycle = 0.8 req/s ΓÇö well within limit.
"""
import asyncio
import logging
...
class _GreeksPoller:
    ...
    # ΓöÇΓöÇ Skeleton build at startup ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    async def build_skeleton(self) -> None:
        ...
        """
        log.info("Building option chain skeleton from instrument_masterΓÇª")
    ...
    # ΓöÇΓöÇ Main poll loop ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ Fetch & store ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

    async def _fetch_and_store(self, underlying: str, expiry: str) -> None:
        """
        Post to /optionchain via dhan_client ΓÇö rate limiting is automatic.
        """
        ...
        if resp.status_code in (401, 403):
            ...
            if "808" in body or "authentication failed" in body or "token invalid" in body:
                ...
                log.error(
                    "Greeks poller paused (15m) ΓÇö Dhan authentication failed (808). "
        ...
        log.debug(
            f"Greeks updated ΓÇö {underlying} {expiry}: {len(rows)} strikes."
        )

    # ΓöÇΓöÇ Active expiry helper ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

...
app/market_hours.py
===================
IST market hours ΓÇö hardcoded per exchange.
...
class MarketState(str, Enum):
    PRE_OPEN   = "PRE_OPEN"    # 09:00ΓÇô09:15 NSE/BSE only
    OPEN       = "OPEN"
    POST_CLOSE = "POST_CLOSE"  # 15:30ΓÇô15:40 NSE closing session
    CLOSED     = "CLOSED"


# ΓöÇΓöÇ Hardcoded session windows (IST) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# Holidays ΓÇö loaded from exchange_holidays table at startup
...
# ΓöÇΓöÇ Scheduler-friendly session helpers (IST) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

def is_equity_window_active(now_ist: datetime | None = None) -> bool:
    """True during NSE/BSE pre-open + session: 09:00ΓÇô15:30 IST on trading days."""
...
def is_commodity_window_active(now_ist: datetime | None = None) -> bool:
    """True during MCX session: 09:00ΓÇô23:30 IST on trading days."""
    now_ist = now_ist or datetime.now(tz=IST)
    today = now_ist.date()
    if _is_exchange_holiday("MCX", today):
        return False
...
# ΓöÇΓöÇ Staleness thresholds (seconds) ΓÇö only meaningful when market is OPEN ΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇ Exchange time sync ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
# Stores the skew between our clock and the exchange's ltt field.
# Only used for staleness monitoring ΓÇö we never adjust the system clock.
...
def record_exchange_tick_time(ltt: datetime) -> None:
    ...
    if abs(skew_ms) > 2000:
        log.warning(
            f"Exchange time skew is {skew_ms:.0f}ms ΓÇö check system clock."
        )
...
# ΓöÇΓöÇ Holiday loading from database ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

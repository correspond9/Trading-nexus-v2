...
def serialize_tick(row: dict[str, Any], segment: str = "NSE_EQ", symbol: str = "") -> dict:
    ...
    Strips qty from bid/ask depth ΓÇö only prices are sent to frontend.
    """
    ...
    # OHLC ΓÇö only during OPEN and POST_CLOSE
...
# ΓöÇΓöÇ Depth serialiser (strips qty) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

def _serialise_depth(depth: list[dict]) -> list[dict]:
    """Drop qty from each level ΓÇö send price-only pairs to frontend."""
    if depth is None:
        return []
...
# ΓöÇΓöÇ Formatting helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

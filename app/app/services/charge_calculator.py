...
class ChargeRates:
    ...
    EXCHANGE_RATES = {
        'NSE_EQ': Decimal('0.00297'),    # Γé╣2.97 per lakh = 0.00297%
        'BSE_EQ': Decimal('0.00375'),    # Γé╣3.75 per lakh = 0.00375%
        'NSE_FNO_FUTURES': Decimal('0.00173'),  # Γé╣1.73 per lakh = 0.00173%
        'NSE_FNO_OPTIONS': Decimal('0.03503'),  # Γé╣35.03 per lakh of premium = 0.03503%
        'BSE_FNO_OPTIONS': Decimal('0.0325'),   # Γé╣32.5 per lakh of premium = 0.0325%
    ...
    # Other Charges
    SEBI_RATE = Decimal('0.000001')      # Γé╣10 per crore  = 0.0001%
    GST_RATE = Decimal('0.18')           # 18%
    STAMP_DUTY_RATE = Decimal('0.00015') # 0.015% on buy side
    
    # IPFT (Inter-transfer charges per crore)
    IPFT_EQUITY = Decimal('0.00001')     # Γé╣10 per crore = 0.001%
    IPFT_FUTURES = Decimal('0.00001')    # Γé╣10 per crore = 0.001%
    IPFT_OPTIONS = Decimal('0.00005')    # Γé╣50 per crore = 0.005%
...
class ChargeCalculator:
    ...
    def calculate_all_charges(
        ...
        Args:
            ...
            brokerage_flat: Flat fee per order (e.g., Γé╣20)
    ...
    def _calculate_brokerage(
        ...
        """Calculate brokerage: flat fee + (turnover ├ù percent)"""
    ...
    def _calculate_sebi_charge(self, turnover: Decimal) -> Decimal:
        """Calculate SEBI charges (Γé╣10 per crore)."""

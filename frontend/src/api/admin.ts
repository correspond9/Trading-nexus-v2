...
export interface TokenStatus {
  effective_mode:   'auto_totp' | 'manual' | 'disabled'
...
export const setAuthMode         = (mode: 'auto_totp' | 'manual') =>
  api.post<{ success: boolean; mode: string; message: string; new_expiry?: string | null }>('/admin/auth-mode', { mode })

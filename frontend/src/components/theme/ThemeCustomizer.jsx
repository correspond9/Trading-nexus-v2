...
const toThemeDefinitionConfig = (themeConfig, componentSettings) => ({
  ...
  accent_contrast: componentSettings?.buttons?.textColor || '#0b1220',
  nm_shadow: themeConfig.shadowDark,
  nm_highlight: themeConfig.shadowLight,
  row_highlight: themeConfig.rowHighlight || (themeConfig.backgroundColor ? '#e2e8f0' : '#1f2937'),
  control_bg: componentSettings?.inputs?.backgroundColor || '#ffffff',
  control_text: componentSettings?.inputs?.textColor || '#0f172a',
  tab_active_bg: componentSettings?.buttons?.backgroundColor || themeConfig.logoBackground || '#2563eb',
  tab_active_text: componentSettings?.buttons?.textColor || '#0b1220',

...
const PayoutsPage = () => {
  ...
  const s = { page: { padding: '24px', fontFamily: 'system-ui,sans-serif', color: 'var(--text)' }, title: { fontSize: '20px', fontWeight: 700, marginBottom: '20px', color: 'var(--text)' }, card: { background: 'var(--surface)', borderRadius: '8px', border: '1px solid var(--border)', padding: '20px' }, th: { padding: '10px 14px', textAlign: 'left', background: 'var(--surface2)', borderBottom: '1px solid var(--border)', fontWeight: 600, color: 'var(--muted)', fontSize: '12px' }, td: { padding: '10px 14px', borderBottom: '1px solid var(--border)', fontSize: '13px', color: 'var(--text)' } };
